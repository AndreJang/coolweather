package com.example.andre.coolweather.database;
...
public class CoolWeatherDB {
    ...
    private static volatile CoolWeatherDB mCoolWeatherDB = null;//添加了volatile修饰
    ...
    public  static CoolWeatherDB getInstance(Context context){
        ...
        CoolWeatherDB coolWeatherDB = mCoolWeatherDB; // <<< 在这里创建临时变量

        if (coolWeatherDB == null){
            synchronized (CoolWeatherDB.class){
                coolWeatherDB = mCoolWeatherDB;
                if (coolWeatherDB == null){
                    coolWeatherDB = new CoolWeatherDB(context);
                    mCoolWeatherDB = coolWeatherDB;
                }
            }
        }

        return coolWeatherDB;// <<< 注意这里返回的是临时变量
    }
