...
import com.example.andre.coolweather.service.AutoUpdateService;
...
public class WeatherActivity extends Activity implements View.OnClickListener{
    ...
    private void showWeather() {
        ...
        //将返回的String类型的气温数据进行了排序
        String temp1 = prefs.getString("temp1", "");
        String[] temp1Arrary = temp1.split("℃");
        String temp2 = prefs.getString("temp2", "");
        String[] temp2Arrary = temp2.split("℃");
        int intTemp1 = Integer.parseInt(temp1Arrary[0]);
        int intTemp2 = Integer.parseInt(temp2Arrary[0]);

        Log.d("WeatherActivity",temp1Arrary[0]);
        Log.d("WeatherActivity",temp2Arrary[0]);
